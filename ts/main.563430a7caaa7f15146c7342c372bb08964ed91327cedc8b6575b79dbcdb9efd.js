"use strict";
(() => {
  // ns-hugo-imp:E:\hugo_blog\myblog\themes\hugo-theme-stack\assets\ts\gallery.ts
  ...
  // ns-hugo-imp:E:\hugo_blog\myblog\themes\hugo-theme-stack\assets\ts\color.ts
  var colorsCache = {};
  ...
  // ns-hugo-imp:E:\hugo_blog\myblog\themes\hugo-theme-stack\assets\ts\menu.ts
  ...
  // ns-hugo-imp:E:\hugo_blog\myblog\themes\hugo-theme-stack\assets\ts\createElement.ts
  ...
  // ns-hugo-imp:E:\hugo_blog\myblog\themes\hugo-theme-stack\assets\ts\colorScheme.ts
  ...
  // ns-hugo-imp:E:\hugo_blog\myblog\themes\hugo-theme-stack\assets\ts\scrollspy.ts
  ...
  // ns-hugo-imp:E:\hugo_blog\myblog\themes\hugo-theme-stack\assets\ts\smoothAnchors.ts
  ...
  var Stack = {
    init: () => {
      ...
      try {
        if (tocToggleBtn && container) {
          if (localStorage.getItem("right-sidebar-hidden") === "1") {
            container.classList.add("right-sidebar-hidden");
            tocToggleBtn.classList.add("floating");
            body.appendChild(tocToggleBtn);
          }
          tocToggleBtn.addEventListener("click", () => {
            const isHidden = container.classList.contains("right-sidebar-hidden");
            container.classList.toggle("right-sidebar-hidden");
            if (isHidden) {
              tocToggleBtn.classList.remove("floating");
              const tocTitle = document.querySelector(".toc-title");
              if (tocTitle) tocTitle.appendChild(tocToggleBtn);
            } else {
              tocToggleBtn.classList.add("floating");
              body.appendChild(tocToggleBtn);
            }
            localStorage.setItem("right-sidebar-hidden", isHidden ? "0" : "1");
          });
        }
      } catch (e) {
        console.warn("Right sidebar toggle failed", e);
      }
    }
  };
